...
//                    }
//                }
//                //  print(self.cameras)  // Для перевірки, що дані правильно зберігаються
...
//    }
//    
////        func getAllPhotos(completion: @escaping ([Photo]) -> Void) {
////            var allPhotos: [Photo] = []
////            let dispatchGroup = DispatchGroup()
////            
////            for rover in rovers {
////                let datesArray = dates(from: rover.landingDate, to: rover.maxDate)
////                
////                for camera in cameras {
////                    for date in datesArray {
////                    dispatchGroup.enter()
////                    getPhotos(rover: rover.name, camera: camera.name, date: rover.landingDate) { photos in
